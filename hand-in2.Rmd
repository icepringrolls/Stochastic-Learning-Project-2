...
```
\subsubsection{i)}
We observe that the loading associated with the variable "Generosity" 
is approximately -0.2 for PC2, and 0.02 for PC1. The large difference in the 
absolute value of the two loadings imply that the "Generosity" variable has a 
greater impact on PC2 than PC1. Meanwhile, we observe that the loading 
associated with "Freedom.to.make.life.choices" is approximately -0.1 for 
both PC1 and PC2. Thus, this variable has nearly equal impact on PC1 and PC2.
